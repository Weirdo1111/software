...
export const officialGameLevels: GameLevel[] = [
  ...
  },
  {
    ...
    duration: "8-12 min",
    status: "locked",
    mission: "Use dorm notices, storage labels, and the RA desk to unlock the hallway exit.",
    reward: "Preview only",
  ...
  },
  {
    ...
    duration: "10-14 min",
    status: "locked",
    mission: "Read the route map, listen for the platform announcement, and clear the gate before the last train leaves.",
    reward: "Preview only",
