...
export const learningModules = [
  {
    ...
    focus: "Lecture signposting, lab briefing capture, and evidence detection.",
    summary: "Short lecture-style clips with note-taking prompts that feel closer to English-medium classroom input.",
    deliverable: "Annotated lecture notes + post-class summary",
    minutes: "18-22 min",
    progress: 72,
